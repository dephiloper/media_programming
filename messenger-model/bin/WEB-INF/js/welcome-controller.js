/**
 * WelcomeController: messenger welcome controller.
	...
	Object.defineProperty(WelcomeController.prototype, "login", {
		...
		value: async function () {
			...
			try {
				...
				const sessionOwner = JSON.parse(await this.xhr("/services/people/0", "GET", {"Accept": "application/json"}, "", "text", email, password));
				Controller.entityCache.put(Controller.sessionOwner = sessionOwner);
